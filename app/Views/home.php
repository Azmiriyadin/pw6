                ...
                <div class="sidebar-content">
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item" id="mndata">
                            <a href="<?= BASEURLKU; ?>bookdata"><i class="icon-note"></i>
                                <p>Data</p>
                            </a>
                        </li>
                        <li class="nav-item" id="mnpelanggan">
                            <a href="<?= BASEURLKU; ?>customer"><i class="icon-user"></i>
                                <p>Pelanggan</p>
                            </a>
                        </li>
                        <li class="nav-item" id="mntentang">
                            <a href="<?= BASEURLKU; ?>about"><i class="icon-tag"></i>
                                <p>Tentang</p>
                            </a>
                        </li>
                    </ul>
