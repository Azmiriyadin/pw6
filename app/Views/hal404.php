...
<head>
    ...
    <script>
         WebFont.load({
            ...
            custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "
               simple-line-icons"], urls: ['<?= BASEURLKU; ?>writable/assets/css/fonts.min.css']},
            active: function(){
    ...
    <style>
        .page-not-found .wrapper.not-found {height: 100vh; display: flex; justify-content: center; align-items: center; flex-direction:
            column; color: #ffffff; background: rgba(0, 0, 0, 0.61);}
        .page-not-found .wrapper.not-found h1{font-size: 100px; letter-spacing: 15em; font-weight: 600; animation-delay: .5s;}
        .page-not-found .wrapper.not-found .desc{font-size: 27px; text-align: center; line-height: 50px; animation-delay: 1.5s;
            Letter-spacing: 2px;}
        .page-not-found .wrapper.not-found .desc span{font-weight: 600; font-size: 30px;}
        .page-not-found .wrapper.not-found .btn-back-home{border-radius: 50px; padding: 13px 25px; animation-delay: 2.5s;}
    </style>
...
<body class="page-not-found">
    <div class="wrapper not-found">
        ...
        <a href="<?= BASEURLKU; ?>"class="btn btn-primary btn-back-home mt-4 animated fadeInUp">
            <span class="btn-label mr-2"><i class="flaticon-home"></i></span>Kembali Ke Beranda</a>
    </div>
